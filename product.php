                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="categories.php?id=<?php echo $get_product['0']['category_id']?>"><?php echo $get_product['0']['categories']?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc">
                                        <p><span>Qty:</span> <?php echo $get_product['0']['qty']?>
                                        <select id="qty">
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
